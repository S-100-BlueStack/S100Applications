        ...
        internal static CardinalBeacon CreateCardinalBeacon(AidsToNavigationP current, int? scaleMinimum, Geodatabase source) {
            ...
            if (current.COLPAT != default) {
                if (instance.colour is not null && instance.colour.Length > 1)
                    instance.colourPattern = "-32767".Equals(current.COLPAT) ? null : ImporterNIS.GetColourPattern(current.COLPAT)!.value;
            }
            ...
            if (current.ELEVAT.HasValue) {
                instance.elevation = current.ELEVAT.Value == -32767 ? null : current.ELEVAT.Value == -32767 ? null : current.ELEVAT.Value;
            }
