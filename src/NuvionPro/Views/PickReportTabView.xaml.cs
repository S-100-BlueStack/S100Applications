...
namespace NuvionPro.Views
{
    /// <summary>
    /// Interaction logic for PickReportTabView.xaml
    /// </summary>
    public partial class PickReportTabView : UserControl /*ArcGIS.Desktop.Framework.Controls.ProWindow*/
    {
        //private readonly ILogger _logger = Logger.Current;

        public PickReportTabView() {
        ...
        private void S100AttributeEditor_Loaded(object sender, System.Windows.RoutedEventArgs e) {
            var viewModel = (PickReportTabViewModel)this.DataContext;
        }
    }
}
